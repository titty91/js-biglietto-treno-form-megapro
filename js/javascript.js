...
var costo = 0.21;
var costoTotale = 0;generaBtn.addEventListener('click', function(){
  ...
  if (name !== '' && distanza > 0 && eta !== ''){    costoTotale = costo * distanza;
    ...
    document.getElementById('codCp').innerHTML = cp;  } else{
    console.log('nah');
  }
